...
REFERENCE_PATH = Path("img/GRF/GRF_RGB_revised.tiff")
MOVING_PATH = Path("img/GRF/GRF_RGB_U_revised.tiff")
...
if __name__ == "__main__":
    ...
    if homography is None:
        print(f"Homography estimation failed: {info}")
    else:
        ...
        checker = checkerboard(crop_to_bbox(reference, bbox),
                               crop_to_bbox(refined_aligned_full, bbox),
                               num_tiles=NUM_TILES)
